...
export const ProjectProvider = ({ children }) => {
  ...
  const addTask = (task_info) => {
    ...
    let updatedProjectBoards = {...project.taskBoards, [taskBoardId]: updatedTaskBoard};
  ...
  const moveTask = (fromBoardId, toBoardId, fromIndex, toIndex) => {
    ...
    const updatedTaskBoards = {...project.taskBoards, [fromBoardId]: updatedSourceBoard, [toBoardId]: updatedDestinationBoard};
